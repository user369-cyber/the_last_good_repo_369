...
client = pymongo.MongoClient(
    "mongodb+srv://rk7018295:rsquare369@cluster0.ckt1qtj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
)
...
def resultpage():
  if request.method == 'POST':
    try:
      ...
      url = 'https://play.google.com/store/search?q=' + searchstring.replace(
          " ", '+') + '&c=apps&hl=en'
      uclient = ureq(url)
      ...
      return render_template("result.html",
                             reviews=review_box[0:(len(review_box) - 1)])
